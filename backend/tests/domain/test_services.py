...
class TestDetectLegalArea:
    ...
    def test_labor_topic_no_longer_out_of_scope(self):
        """Decisión 2026-07-23: el Código Sustantivo del Trabajo completo entró
        al corpus (ver .aiplans/ingest-codigo-sustantivo-trabajo/), así que
        preguntas de despido/terminación del contrato ya no se redirigen como
        fuera de alcance — deben resolverse por retrieval normal."""
        assert detect_legal_area("¿me pueden despedir sin justa causa?") is None
