...
export function SearchBox({ onSubmit, isLoading = false }: SearchBoxProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      <div className="flex items-center gap-2.5 bg-surface border-[1.5px] border-border hover:border-terra focus-within:border-terra focus-within:ring-2 focus-within:ring-terra-light rounded-xl px-4 py-3 transition-all duration-150 min-h-[52px]">
